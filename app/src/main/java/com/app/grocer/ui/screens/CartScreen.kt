...
import com.app.grocer.ui.components.CartItem
...
fun CartScreen(
    ...
    val totalSavings = cartItems.value.sumOf {
        val savingsPerItem =
            it.product.price - (it.product.price * (1 - it.product.discount / 100.0))
    ...
    Column(
        ...
        LazyColumn(
            modifier = Modifier
              .weight(1f) // Allow the cart items to scroll if they exceed the screen height
                .fillMaxSize()
        ) {
                    ...
                    navController.navigate(
                        Route.CreateOrderScreen(
                            createOrderRequest = CreateOrderRequest(
                                ...
                                shippingAddress = ShippingAddressX(
